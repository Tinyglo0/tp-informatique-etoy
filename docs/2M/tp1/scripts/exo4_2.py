...
for i in range(len(country)):
    if country[i] == "United Kingdom":
        villes_uk.append(city[i])

# --------- PYODIDE:secrets --------- #
assert len(villes_uk) == 3, "Le nombre de villes n'est pas correct."
assert villes_uk == ["London", "London", "London"], "Les villes ne sont pas correctes."
