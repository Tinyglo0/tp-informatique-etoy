...
# --------- PYODIDE:code --------- #
# 4. Affectez à la variable 'ville_2016' le nom de la ville qui a organisé les JO en '2016'.
# Parcourez les listes pour trouver la réponse.
ville_2016 = ""
...
# --------- PYODIDE:secrets --------- #
assert ville_2016 == "Rio de Janeiro", "La ville trouvée n'est pas correcte."
